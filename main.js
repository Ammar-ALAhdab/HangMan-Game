  ...
  myRequest.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      ...
      arabicButt.addEventListener("click", () => {
        ...
        document.querySelector(".category .word-type").innerHTML =
          "نوع الكلمة :";
        // RTL Arabic Charcters
        lettersContainer.setAttribute("dir", "rtl");
        chossenWord = generate(myData.wordsAR);
      ...
      englishButt.addEventListener("click", () => {
        ...
        chossenWord = generate(myData.wordsEN);
      });
      ...
      function hint() {
        // Play Sound Effect
        hintButt.classList.add("just-once");
        document.getElementById("hint").play();
        let onceTime = true;
